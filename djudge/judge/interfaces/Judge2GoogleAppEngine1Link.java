...
public class Judge2GoogleAppEngine1Link extends Thread
{
	private static final Logger log = Logger
			.getLogger(Judge2GoogleAppEngine1Link.class);
	
	private String rootUrl = "http://uzh2010.appspot.com/";
	...
	{
		new Judge2GoogleAppEngine1Link().start();
	}
}
