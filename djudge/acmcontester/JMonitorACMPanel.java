...
public class JMonitorACMPanel extends JPanel implements ActionListener
{
	...
	public JMonitorACMPanel(TeamXmlRpcInterface serverInterface, AuthentificationDataProvider authProvider)
	{
